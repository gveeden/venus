...
Rectangle {
    ...
    readonly property color buttonColor: {
        switch (variant) {
            ...
            case "solid":
            default: return Appearance.colors.primary
        }
    }
    
    readonly property color textColor: {
        switch (variant) {
            case "outline": return Appearance.colors.primary
            case "ghost": return Appearance.colors.primary
            case "solid":
            default: return Appearance.colors.background
        }
    }
