    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.background = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.surface = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.primary = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.secondary = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.text = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.textSecondary = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.textTertiary = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.border = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.hover = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.surfaceHighlight = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.primaryContainer = newColor; themeStorage.save() }
            }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.secondaryContainer = newColor; themeStorage.save() }
            }
        }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Slider {
                    ...
                    onValueChanged: { Appearance.window.borderThickness = Math.round(value); themeStorage.save() }
                }
            ...
            ColorPicker {
                ...
                onColorChanged: (newColor) => { Appearance.colors.windowBorder = newColor; themeStorage.save() }
            }
            ...
            RowLayout {
                ...
                Slider {
                    ...
                    onValueChanged: { Appearance.window.radius = Math.round(value); themeStorage.save() }
                }
